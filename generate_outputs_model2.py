...
target = "D:/fax/aadspproj/aadspProj/model2/Debug/model2"
...
test_outputs = os.path.join(os.path.dirname(__file__), "outputStreams/model2")
...
def run_test(case):
    ...
    out_file = os.path.join(test_dir, f'out_{test_name}_m2.wav')

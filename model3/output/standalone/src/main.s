...
init_latch_label_1:			/* LN: 70 | CYCLE: 0 | RULES: () */ 
	...
	a0 = a0 - a1			# LN: 65 | 
	i0 = i7 - (0x8)			# LN: 65 | 
label_end_92:			# LN: 65 | CYCLE: 5 | RULES: ()
	xmem[i0] = a0h			# LN: 65 | 
...
for_end_2:			/* LN: 80 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x4)			# LN: 88 | 
	a0 = xmem[i0]			# LN: 88 | 
	jmp (__epilogue_222)			# LN: 88 | 
cline_88_0:			/* LN: 89 | CYCLE: 0 | RULES: () */ 
__epilogue_222:			/* LN: 89 | CYCLE: 0 | RULES: () */ 
	i7 = i7 - (0xb)			# LN: 89 | 
	i7 -= 1			# LN: 89 | 
	ret			# LN: 89 | 
...
cline_42_0:			/* LN: 43 | CYCLE: 0 | RULES: () */ 
	...
	a0 = 0			# LN: 43 | 
	xmem[i0] = a0h			# LN: 43 | 
	do (0x17), label_end_95			# LN: 43 | 
cline_43_0:			/* LN: 45 | CYCLE: 0 | RULES: () */ 
label_begin_95:			/* LN: 43 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x2)			# LN: 45 | 
	i0 = xmem[i0]			# LN: 45 | 
	a0 = 0			# LN: 45 | 
	xmem[i0] = a0h			# LN: 45 | 
...
init_latch_label_0:			/* LN: 49 | CYCLE: 0 | RULES: () */ 
	...
	a0 = a0 + a1			# LN: 43 | 
	i0 = i7 - (0x4)			# LN: 43 | 
label_end_95:			# LN: 43 | CYCLE: 5 | RULES: ()
	xmem[i0] = a0h			# LN: 43 | 
cline_43_1:			/* LN: 51 | CYCLE: 0 | RULES: () */ 
for_end_0:			/* LN: 43 | CYCLE: 0 | RULES: () */ 
	jmp (__epilogue_220)			# LN: 51 | 
__epilogue_220:			/* LN: 51 | CYCLE: 0 | RULES: () */ 
	i7 = i7 - (0x4)			# LN: 51 | 
	i7 -= 1			# LN: 51 | 
	ret			# LN: 51 | 
...
_main:			/* LN: 205 | CYCLE: 0 | RULES: () */ 
	...
	i1 = i7 - (0x2)			# LN: 205 | 
	xmem[i1] = i0			# LN: 205 | 
cline_205_0:			/* LN: 222 | CYCLE: 0 | RULES: () */ 
	a0 = xmem[__extractedConst_0_1 + 0]			# LN: 222 | 
	i0 = i7 - (0x3)			# LN: 222 | 
	xmem[i0] = a0h			# LN: 222 | 
cline_222_0:			/* LN: 223 | CYCLE: 0 | RULES: () */ 
	uhalfword(a0) = (0x1)			# LN: 223 | 
	xmem[_enableFlag + 0] = a0h			# LN: 223 | 
cline_223_0:			/* LN: 224 | CYCLE: 0 | RULES: () */ 
	a0 = 0			# LN: 224 | 
	xmem[_modeFlag + 0] = a0h			# LN: 224 | 
cline_224_0:			/* LN: 226 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x1)			# LN: 226 | 
	a0 = xmem[i0]			# LN: 226 | 
	uhalfword(a1) = (0x5)			# LN: 226 | 
	a0 - a1			# LN: 226 | 
	if (a != 0) jmp (else_3)			# LN: 226 | 
cline_226_0:			/* LN: 227 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x2)			# LN: 227 | 
	i0 = xmem[i0]			# LN: 227 | 
	i1 = (0) + (_string_const_0)			# LN: 227 | 
	i0 = i0 + (0x3)			# LN: 227 | 
	i0 = xmem[i0]			# LN: 227 | 
	call (_strcmp)			# LN: 227 | 
	a0 & a0			# LN: 227 | 
	if (a != 0) jmp (else_4)			# LN: 227 | 
cline_227_0:			/* LN: 228 | CYCLE: 0 | RULES: () */ 
	a0 = xmem[__extractedConst_1_1 + 0]			# LN: 228 | 
	i0 = i7 - (0x3)			# LN: 228 | 
	xmem[i0] = a0h			# LN: 228 | 
	jmp (endif_4)			# LN: 228 | 
cline_228_0:			/* LN: 229 | CYCLE: 0 | RULES: () */ 
else_4:			/* LN: 227 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x2)			# LN: 229 | 
	i0 = xmem[i0]			# LN: 229 | 
	i1 = (0) + (_string_const_1)			# LN: 229 | 
	i0 = i0 + (0x3)			# LN: 229 | 
	i0 = xmem[i0]			# LN: 229 | 
	call (_strcmp)			# LN: 229 | 
	a0 & a0			# LN: 229 | 
	if (a != 0) jmp (else_5)			# LN: 229 | 
cline_229_0:			/* LN: 230 | CYCLE: 0 | RULES: () */ 
	a0 = xmem[__extractedConst_2_1 + 0]			# LN: 230 | 
	i0 = i7 - (0x3)			# LN: 230 | 
	xmem[i0] = a0h			# LN: 230 | 
	jmp (endif_5)			# LN: 230 | 
cline_230_0:			/* LN: 234 | CYCLE: 0 | RULES: () */ 
endif_4:			/* LN: 227 | CYCLE: 0 | RULES: () */ 
endif_5:			/* LN: 229 | CYCLE: 0 | RULES: () */ 
else_5:			/* LN: 229 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x2)			# LN: 234 | 
	i0 = xmem[i0]			# LN: 234 | 
...
endif_3:			/* LN: 226 | CYCLE: 0 | RULES: () */ 
else_3:			/* LN: 226 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x4)			# LN: 245 | 
	a0 = 0			# LN: 245 | 
	xmem[i0] = a0h			# LN: 245 | 
	do (0x8), label_end_97			# LN: 245 | 
cline_245_0:			/* LN: 246 | CYCLE: 0 | RULES: () */ 
label_begin_97:			/* LN: 245 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x5)			# LN: 246 | 
	a0 = 0			# LN: 246 | 
	xmem[i0] = a0h			# LN: 246 | 
	do (0x10), label_end_96			# LN: 246 | 
cline_246_0:			/* LN: 247 | CYCLE: 0 | RULES: () */ 
label_begin_96:			/* LN: 246 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x4)			# LN: 247 | 
...
init_latch_label_4:			/* LN: 247 | CYCLE: 0 | RULES: () */ 
	...
	a0 = a0 + a1			# LN: 246 | 
	i0 = i7 - (0x5)			# LN: 246 | 
label_end_96:			# LN: 246 | CYCLE: 5 | RULES: ()
	xmem[i0] = a0h			# LN: 246 | 
cline_246_1:			/* LN: 245 | CYCLE: 0 | RULES: () */ 
init_latch_label_5:			/* LN: 247 | CYCLE: 0 | RULES: () */ 
for_end_5:			/* LN: 246 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x4)			# LN: 245 | 
	a0 = xmem[i0]			# LN: 245 | 
	uhalfword(a1) = (0x1)			# LN: 245 | 
	a0 = a0 + a1			# LN: 245 | 
	i0 = i7 - (0x4)			# LN: 245 | 
label_end_97:			# LN: 245 | CYCLE: 5 | RULES: ()
	xmem[i0] = a0h			# LN: 245 | 
...
endif_9:			/* LN: 272 | CYCLE: 0 | RULES: () */ 
else_9:			/* LN: 272 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (522 - 0)			# LN: 276 | 
	i1 = i7 - (0x108)			# LN: 276 | 
	a0 = xmem[i1]			# LN: 276 | 
	i1 = i7 - (0x20b)			# LN: 276 | 
...
for_6:			/* LN: 294 | CYCLE: 0 | RULES: () */ 
	...
	a1 = xmem[i0]			# LN: 294 | 
	a1 - a0			# LN: 294 | 
	if (a >= 0) jmp (for_end_6)			# LN: 294 | 
cline_294_0:			/* LN: 296 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x5)			# LN: 296 | 
	a0 = 0			# LN: 296 | 
	xmem[i0] = a0h			# LN: 296 | 
	do (0x10), label_end_98			# LN: 296 | 
cline_296_0:			/* LN: 298 | CYCLE: 0 | RULES: () */ 
label_begin_98:			/* LN: 296 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 298 | 
	a0 = 0			# LN: 298 | 
	xmem[i0] = a0h			# LN: 298 | 
for_8:			/* LN: 298 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 298 | 
	a0 = xmem[i0]			# LN: 298 | 
	i0 = i7 - (0x107)			# LN: 298 | 
	a1 = xmem[i0]			# LN: 298 | 
	a0 - a1			# LN: 298 | 
	if (a >= 0) jmp (for_end_8)			# LN: 298 | 
...
init_latch_label_6:			/* LN: 302 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 298 | 
	a0 = xmem[i0]			# LN: 298 | 
...
init_latch_label_7:			/* LN: 303 | CYCLE: 0 | RULES: () */ 
for_end_8:			/* LN: 298 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x5)			# LN: 296 | 
	a0 = xmem[i0]			# LN: 296 | 
	uhalfword(a1) = (0x1)			# LN: 296 | 
	a0 = a0 + a1			# LN: 296 | 
	i0 = i7 - (0x5)			# LN: 296 | 
label_end_98:			# LN: 296 | CYCLE: 5 | RULES: ()
	xmem[i0] = a0h			# LN: 296 | 
cline_296_1:			/* LN: 306 | CYCLE: 0 | RULES: () */ 
for_end_7:			/* LN: 296 | CYCLE: 0 | RULES: () */ 
	a0 = xmem[_enableFlag + 0]			# LN: 306 | 
	a0 & a0			# LN: 306 | 
	if (a == 0) jmp (else_11)			# LN: 306 | 
cline_306_0:			/* LN: 308 | CYCLE: 0 | RULES: () */ 
	i0 = (0) + (_sampleBuffer)			# LN: 308 | 
	i1 = (0) + (_sampleBuffer)			# LN: 308 | 
	call (_processing)			# LN: 308 | 
	jmp (endif_11)			# LN: 308 | 
cline_308_0:			/* LN: 311 | CYCLE: 0 | RULES: () */ 
endif_11:			/* LN: 306 | CYCLE: 0 | RULES: () */ 
else_11:			/* LN: 306 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x5)			# LN: 311 | 
	a0 = 0			# LN: 311 | 
	xmem[i0] = a0h			# LN: 311 | 
	do (0x10), label_end_99			# LN: 311 | 
cline_311_0:			/* LN: 313 | CYCLE: 0 | RULES: () */ 
label_begin_99:			/* LN: 311 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 313 | 
	a0 = 0			# LN: 313 | 
	xmem[i0] = a0h			# LN: 313 | 
for_10:			/* LN: 313 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 313 | 
	a0 = xmem[i0]			# LN: 313 | 
	i0 = i7 - (0x20b)			# LN: 313 | 
	a1 = xmem[i0]			# LN: 313 | 
	a0 - a1			# LN: 313 | 
	if (a >= 0) jmp (for_end_10)			# LN: 313 | 
cline_313_0:			/* LN: 315 | CYCLE: 0 | RULES: () */ 
	...
	i0 = a0			# LN: 315 | 
	i1 = i7 - (0x5)			# LN: 315 | 
	i0 = i0 + (_sampleBuffer + 0)			# LN: 315 | 
	a0 = xmem[i1]			# LN: 315 | 
	a1 = i0			# LN: 315 | 
	a0 = a1 + a0			# LN: 315 | 
	AnyReg(i0, a0h)			# LN: 315 | 
	i1 = i7 - (0x20e)			# LN: 315 | 
	a0 = xmem[i0]			# LN: 315 | 
	xmem[i1] = a0h			# LN: 315 | 
cline_315_0:			/* LN: 316 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20c)			# LN: 316 | 
	i1 = i7 - (0x20e)			# LN: 316 | 
	a0 = xmem[i1]			# LN: 316 | 
	i0 = xmem[i0]			# LN: 316 | 
	call (_cl_wavwrite_sendsample)			# LN: 316 | 
cline_316_0:			/* LN: 313 | CYCLE: 0 | RULES: () */ 
init_latch_label_8:			/* LN: 317 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20d)			# LN: 313 | 
	a0 = xmem[i0]			# LN: 313 | 
	...
	xmem[i0] = a0h			# LN: 313 | 
	jmp (for_10)			# LN: 313 | 
cline_313_1:			/* LN: 311 | CYCLE: 0 | RULES: () */ 
init_latch_label_9:			/* LN: 318 | CYCLE: 0 | RULES: () */ 
for_end_10:			/* LN: 313 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x5)			# LN: 311 | 
	a0 = xmem[i0]			# LN: 311 | 
	uhalfword(a1) = (0x1)			# LN: 311 | 
	a0 = a0 + a1			# LN: 311 | 
	i0 = i7 - (0x5)			# LN: 311 | 
label_end_99:			# LN: 311 | CYCLE: 5 | RULES: ()
	xmem[i0] = a0h			# LN: 311 | 
cline_311_1:			/* LN: 294 | CYCLE: 0 | RULES: () */ 
init_latch_label_10:			/* LN: 319 | CYCLE: 0 | RULES: () */ 
for_end_9:			/* LN: 311 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x4)			# LN: 294 | 
	a0 = xmem[i0]			# LN: 294 | 
	...
	xmem[i0] = a0h			# LN: 294 | 
	jmp (for_6)			# LN: 294 | 
cline_294_1:			/* LN: 324 | CYCLE: 0 | RULES: () */ 
for_end_6:			/* LN: 294 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x106)			# LN: 324 | 
	i0 = xmem[i0]			# LN: 324 | 
	call (_cl_wavread_close)			# LN: 324 | 
cline_324_0:			/* LN: 325 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x20c)			# LN: 325 | 
	i0 = xmem[i0]			# LN: 325 | 
	call (_cl_wavwrite_close)			# LN: 325 | 
cline_325_0:			/* LN: 328 | CYCLE: 0 | RULES: () */ 
	a0 = 0			# LN: 328 | 
	jmp (__epilogue_228)			# LN: 328 | 
cline_328_0:			/* LN: 329 | CYCLE: 0 | RULES: () */ 
__epilogue_228:			/* LN: 329 | CYCLE: 0 | RULES: () */ 
	i7 = i7 - (0x20e)			# LN: 329 | 
	i7 -= 1			# LN: 329 | 
	ret			# LN: 329 | 
...
_processing:			/* LN: 106 | CYCLE: 0 | RULES: () */ 
	xmem[i7] = i7			# LN: 106 | 
	i7 += 1			# LN: 106 | 
	i7 = i7 + (0x13)			# LN: 106 | 
	i4 = i7 - (0x1)			# LN: 106 | 
...
cline_120_0:			/* LN: 123 | CYCLE: 0 | RULES: () */ 
	...
	a0 = 0			# LN: 123 | 
	xmem[i0] = a0h			# LN: 123 | 
	do (0x10), label_end_94			# LN: 123 | 
cline_123_0:			/* LN: 127 | CYCLE: 0 | RULES: () */ 
label_begin_94:			/* LN: 123 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x3)			# LN: 127 | 
	i0 = xmem[i0]			# LN: 127 | 
	x0 = xmem[_inputGain + 0]			# LN: 127 | 
	x1 = xmem[i0]			# LN: 127 | 
	a0 = x1 * x0			# LN: 127 | 
	i0 = i7 - (0xc)			# LN: 127 | 
...
cline_132_0:			/* LN: 134 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0xf)			# LN: 134 | 
	a0g = xmem[i0]; i0 += 1			# LN: 134, 134 | 
	a0h = xmem[i0]; i0 += 1			# LN: 134, 134 | 
	a0l = xmem[i0]			# LN: 134 | 
	a0 = a0			# LN: 134 | 
	call (_saturation)			# LN: 134 | 
	i0 = i7 - (0x6)			# LN: 134 | 
	i0 = xmem[i0]			# LN: 134 | 
	nop #empty cycle
	xmem[i0] = a0h			# LN: 134 | 
cline_134_0:			/* LN: 137 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0xc)			# LN: 137 | 
...
cline_138_0:			/* LN: 140 | CYCLE: 0 | RULES: () */ 
	a0 = xmem[_modeFlag + 0]			# LN: 140 | 
	a0 & a0			# LN: 140 | 
	if (a == 0) jmp (else_2)			# LN: 140 | 
cline_140_0:			/* LN: 142 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x5)			# LN: 142 | 
	i0 = xmem[i0]			# LN: 142 | 
	i1 = (0) + (_hpfCoefs)			# LN: 142 | 
	a0 = xmem[i0]			# LN: 142 | 
	i4 = (0) + (_hpfHistoryBuffer)			# LN: 142 | 
	i0 = i1			# LN: 142 | 
	i1 = i4			# LN: 142 | 
	call (_fir_basic)			# LN: 142 | 
	i0 = i7 - (0x5)			# LN: 142 | 
	i0 = xmem[i0]			# LN: 142 | 
	nop #empty cycle
	xmem[i0] = a0h			# LN: 142 | 
cline_142_0:			/* LN: 143 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x6)			# LN: 143 | 
	i0 = xmem[i0]			# LN: 143 | 
	i1 = (0) + (_lpfCoefs)			# LN: 143 | 
	a0 = xmem[i0]			# LN: 143 | 
	i4 = (0) + (_lpfHistoryBuffer)			# LN: 143 | 
	i0 = i1			# LN: 143 | 
	i1 = i4			# LN: 143 | 
	call (_fir_basic)			# LN: 143 | 
	i0 = i7 - (0x6)			# LN: 143 | 
	i0 = xmem[i0]			# LN: 143 | 
	nop #empty cycle
	xmem[i0] = a0h			# LN: 143 | 
	jmp (endif_2)			# LN: 143 | 
cline_143_0:			/* LN: 153 | CYCLE: 0 | RULES: () */ 
...
else_2:			/* LN: 140 | CYCLE: 0 | RULES: () */ 
	...
	i1 = i7 - (0xc)			# LN: 153 | 
	a0 = xmem[i0]			# LN: 153 | 
	xmem[i1] = a0g; i1 += 1			# LN: 153, 153 | 
	xmem[i1] = a0h; i1 += 1			# LN: 153, 153 | 
	xmem[i1] = a0l			# LN: 153 | 
cline_153_0:			/* LN: 154 | CYCLE: 0 | RULES: () */ 
	...
	i1 = i7 - (0xf)			# LN: 154 | 
	a0 = xmem[i0]			# LN: 154 | 
	xmem[i1] = a0g; i1 += 1			# LN: 154, 154 | 
	xmem[i1] = a0h; i1 += 1			# LN: 154, 154 | 
	xmem[i1] = a0l			# LN: 154 | 
cline_154_0:			/* LN: 159 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0xc)			# LN: 159 | 
	...
	a0 = a0			# LN: 159 | 
	i0 = i7 - (0xf)			# LN: 159 | 
	a1g = xmem[i0]; i0 += 1			# LN: 159, 159 | 
	a1h = xmem[i0]; i0 += 1			# LN: 159, 159 | 
	a1l = xmem[i0]			# LN: 159 | 
	a1 = a1			# LN: 159 | 
	a0 = a0 + a1			# LN: 159 | 
	i0 = i7 - (0x12)			# LN: 159 | 
	xmem[i0] = a0g; i0 += 1			# LN: 159, 159 | 
	xmem[i0] = a0h; i0 += 1			# LN: 159, 159 | 
	xmem[i0] = a0l			# LN: 159 | 
cline_159_0:			/* LN: 160 | CYCLE: 0 | RULES: () */ 
	...
	a0l = xmem[i0]			# LN: 160 | 
	a0 = a0			# LN: 160 | 
	call (_saturation)			# LN: 160 | 
	i0 = i7 - (0x7)			# LN: 160 | 
	i0 = xmem[i0]			# LN: 160 | 
	nop #empty cycle
	xmem[i0] = a0h			# LN: 160 | 
cline_160_0:			/* LN: 167 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x3)			# LN: 167 | 
	i0 = xmem[i0]			# LN: 167 | 
	i1 = i7 - (0x3)			# LN: 167 | 
	i0 += 1			# LN: 167 | 
...
cline_173_0:			/* LN: 174 | CYCLE: 0 | RULES: () */ 
	...
	i0 += 1			# LN: 174 | 
	xmem[i1] = i0			# LN: 174 | 
cline_174_0:			/* LN: 123 | CYCLE: 0 | RULES: () */ 
init_latch_label_3:			/* LN: 176 | CYCLE: 0 | RULES: () */ 
	...
	a0 = a0 + a1			# LN: 123 | 
	i0 = i7 - (0x13)			# LN: 123 | 
label_end_94:			# LN: 123 | CYCLE: 5 | RULES: ()
	xmem[i0] = a0h			# LN: 123 | 
cline_123_1:			/* LN: 177 | CYCLE: 0 | RULES: () */ 
for_end_3:			/* LN: 123 | CYCLE: 0 | RULES: () */ 
	jmp (__epilogue_226)			# LN: 177 | 
__epilogue_226:			/* LN: 177 | CYCLE: 0 | RULES: () */ 
	i7 = i7 - (0x13)			# LN: 177 | 
	i7 -= 1			# LN: 177 | 
	ret			# LN: 177 | 
...
else_1:			/* LN: 98 | CYCLE: 0 | RULES: () */ 
	i0 = i7 - (0x1)			# LN: 103 | 
	a0 = xmem[i0]			# LN: 103 | 
	jmp (__epilogue_224)			# LN: 103 | 
cline_103_0:			/* LN: 104 | CYCLE: 0 | RULES: () */ 
__epilogue_224:			/* LN: 104 | CYCLE: 0 | RULES: () */ 
	i7 = i7 - (0x1)			# LN: 104 | 
	i7 -= 1			# LN: 104 | 
	ret			# LN: 104 | 
